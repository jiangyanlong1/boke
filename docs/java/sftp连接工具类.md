...
public class SFTPUtil {
    ...
    public String upload(String directory, String sftpFileName, InputStream input) throws SftpException{
        ...
        return "https://www.jingjilt.com/dianziqikan/" + sftpFileName;
    }

    /**
     * 将输入流的数据上传到sftp作为文件
     */
    public String uploadImg(String directory, String dzqkId, String sftpFileName, InputStream input) throws SftpException{
        try {
            directory = directory + "/" + dzqkId;
        ...
        sftp.put(input, sftpFileName);
        log.info("file:{} is upload successful" , sftpFileName);
        return "https://www.jingjilt.com/dianziqikan/" + dzqkId + "/" + sftpFileName;
    }
    ...
    public static void main(String[] args) throws SftpException, IOException {
        ...
        File file = new File("D:\\11\\新建文件夹\\经济论坛\\电子期刊\\2022-10B_未命名\\1.jpg");
        InputStream is = new FileInputStream(file);
//        sftp.delete(sftpConfigModel.getUploadUrl(),"NCOMP_STHO_20201103_03_0001_CONTROL.txt");
//        String fileUrl = sftp.uploadImg(sftpConfigModel.getUploadUrl(),"111", "这是我上传的图片.jpg", is);
//        sftp.download("/Users/Administrator/Desktop/1","1.jpg","D:/xiangmu");
